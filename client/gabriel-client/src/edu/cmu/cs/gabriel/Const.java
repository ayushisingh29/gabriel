...
public class Const {
    ...
    public static final int AUDIO_STREAM_PORT = 9102;
    ...
    /************************ Demo mode only *************************************/
    // server IP
    // public static final String SERVER_IP = "128.237.212.247"; // Cloudlet
    public static final String SERVER_IP = "10.0.0.19"; // Cloudlet
    ...
    // server IP list
    // public static final String[] SERVER_IP_LIST = { "128.237.212.247", };
    public static final String[] SERVER_IP_LIST = { "10.0.0.19", };
